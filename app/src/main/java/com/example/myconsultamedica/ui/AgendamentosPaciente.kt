...
class AgendamentosPaciente : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_agendamentos_paciente)

        // getting the recyclerview by its id
        val recyclerview = findViewById<RecyclerView>(R.id.rv_agendamentos_paciente)

        // this creates a vertical layout Manager
        recyclerview.layoutManager = LinearLayoutManager(this)

        // ArrayList of class ItemsViewModel
        val data = ArrayList<ViewModelAgendamentosPaciente>()

        // This loop will create 20 Views containing
        // the image with the count of view
        for (i in 1..21) {
            data.add(ViewModelAgendamentosPaciente("Consulta " + i, "Dr "+i,"especialista" +i, "01/01/22","08:00", R.drawable.ic_baseline_edit_24))
        }
